...
- `Character` - name, hp, level, _base_hp_, abilities (ex: Mage)
- `Ability`- name
    - 'Tank' - taunt_radius
    - 'Healer' - heal_power
...
- anything that belongs to a _pairing_ rather than to either side alone (e.g. "how many of this item does this character hold" belongs to the character-item pairing, not to the character or the item).
